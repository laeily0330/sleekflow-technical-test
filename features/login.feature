Feature: SleekFlow User Account Authentication
  ...
  Scenario: Log in with valid user credentials successfully
    ...
    Then I should see my "lely0330@gmail.com" email displayed on the password screen
  ...
  Scenario: Log in failed with unregistered email format
    When I enter an invalid formatted email "notanemail@id"
    And I click the login continue button
    Then I should see my "notanemail@id" email displayed on the password screen
